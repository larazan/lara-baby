<div class="max-w-full xl:max-w-[1800px] mx-auto  flex flex-col justify-center items-center bg-white">
    <div class="w-11/12 mx-auto">
        <div class=" md:pb-16 mt-10 md:mt-[72px] ">
            <div class="mt-4 md:mt-[72px] flex flex-col">
                ...
                <div class="flex flex-col md:flex-row w-full lg:max-w-7xl">
                    ...
                    <div class="overflow-x-auto overflow-hidden custom-scrollbar md:w-9/12 lg:w-9/12 md:-mt-4 ">
                        <div>
                            <div class="w-full">
                                <div class="w-full table">
                                    <div class="w-full flex justify-center px-0 pb-6 md:-ml-2 md:px-4">

                                        @foreach($facts as $f)
                                        @if($f->original)
                                        <div
                                            class="relative mb-0 rounded w-full2 w-64 mr-3 last:mr-0 h-[365px] md:h-[365px] border group flex flex-col overflow-hidden justify-center shadow-md items-center"
                                            ...
                                            <div class="absolute bottom-8 z-20 pl-2">
                                                <h3 class="font-bold font-sans bg-text inline leading-snug pb-8 bottom-10 bg-white bg-none bg-repeat bg-scroll box-decoration-clone capitalize mb-2.5 px-0 py-1 text-[#20bd70] @if($f->beta <= 100){{ 'text-2xl md:text-2xl lg:text-2xl' }}@else{{ 'text-lg md:text-lg lg:text-lg' }}@endif md:mb-[4px]">
                                                    {!! $f->title !!}
                                                </h3>
                                        ...
                                        @else
                                        <div
                                            class="relative mb-0 rounded w-full2 w-64 mr-3 last:mr-0 border group flex flex-col overflow-hidden justify-center shadow-md items-center"
                                            x-data="{ showInfo: false }"
