...
<div class="bg-green-200 px-6 py-4 mx-21 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
...
<div class="bg-red-200 px-6 py-4 mx-21 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
...
<div class="bg-blue-200 px-6 py-4 mx-21 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
