                        ...
                        <div class="flex flex-col text-md leading-5 md:text-lg md:leading-6 font-semibold text-black custom-rich-text mb-7 md:mb-8">
                            <div>
                                <div>
                                    ...
                                    <div 
                                        class="flex flex-col my-4 h-fit w-24 rounded-lg"
                                        style="box-shadow: 0 1px 0 #bdbdbd, 0 2px 0 #fff, 0 3px 0 #bdbdbd, 0 4px 0 #fff, 0 5px 0 #bdbdbd, 0 0 0 1px #bdbdbd;"
                                    >
                                        <div 
                                            class="flex items-center justify-center py-1.5 shadow-md bg-[#fd9f1b] shadow-[#fd9f1b] border-b-2 border-orange-500 border-dotted text-white rounded-t-lg h-full w-full"
                                            style="border-bottom: 1px dashed #f37302; box-shadow: 0 2px 0 #fd9f1b;"
                                        >
                                            <div class="text-sm md:text-lg">{{ date('F') }}</div>
                                        </div>
                                        <div 
                                            class="flex flex-col justify-center items-center bg-white text-slate-900 w-full h-16 md:h-20 rounded-b-lg"   
                                        >
                                            <div class="text-3xl md:text-5xl">{{ date('d') }}</div>
                                        </div>
{{-- 
                                    ...
                                    <p class="font-sans">
                                        Discover what happened on today summaries of major events.
                                    </p>
                                    <p class="font-sans"></p>
                                </div>
                            </div>
                    ...
                    <div class="overflow-x-auto overflow-hidden custom-scrollbar md:w-7/12 lg:w-7/12 md:-mt-4 ">
                        @if($facts->count() > 0)
                        <div class="relative col-span-2 w-full h-full2" x-data="carousel()" x-init="loop()">
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div
                                        ...
                                        <div class="absolute z-0 bottom-0 h-56 w-full bg-gradient-to-b from-transparent to-[#0a1016]"></div>
                                        <div class="absolute bottom-20 left-2 md:left-7 pl-2 z-0 w-full mx-auto max-w-3xl">
                                            <h3 class=" font-bold font-sans bg-text capitalize mb-1 px-0 py-2 leading-tight text-white @if($fact->beta <= 100){{ 'text-2xl md:text-6xl lg:text-6xl' }}@else{{ 'text-lg md:text-2xl lg:text-2xl' }}@endif md:mb-[2px]">
                                                In {{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $fact->history_time)->year }}, {!! $fact->title !!}
                                            </h3>
                                        </div>
                                        <div class="absolute bottom-2 left-2 z-0">
                                            @if($fact->credit)
                                            <p class="px-1 text-white text-[10px] font-sans font-extralight">@ {!! $fact->credit !!}</p>
                                            @endif
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col justify-center items-center px-10 md:px-20 py-6 lg:py-4 md:py-6">
                                            ...
                                            <p
                                                class="mt-4 leading-tight md:leading-tight lg:leading-tight text-wrap text-white text-center @if($fact->beta <= 100){{ 'text-2xl md:text-3xl lg:text-3xl' }}@else{{ 'text-lg md:text-2xl lg:text-2xl' }}@endif pally-bold"
                                                style="color: {{ $fact->color }}">
                                                On {{ Carbon\Carbon::createFromFormat('Y-m-d', $fact->history_time)->format('M. d, Y') }}, {!! $fact->title !!}
                                            </p>
                                        </div>
                                        <div class="absolute z-0 bottom-0 h-full w-full rounded-md px-2 pt-0 opacity-0 group-hover:opacity-100 bg-gradient-to-b from-transparent to-[#0a1016]">
                                            ...
                                            @endif
                                            <div class="absolute bottom-0 right-0 px-3 py-3 mb-2" x-data="{ input: '{{ $fact->title }}', showMsg: false, clickCopy: false }">
                                                <div class="flex inline-flex2 flex-col space-y-2 ">
                            ...
                            <div class="flex z-20">
                                <button 
                                    @click="prev" 
                                    id="prev"
                                    class="absolute top-1/2 transform -translate-y-1/2 left-0 bg-slate-100 text-blue-600 hover:bg-blue-500 hover:text-white transition font-bold rounded-full w-10 h-10 md:w-12 md:h-12 shadow flex justify-center items-center  ml-2 md:ml-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="size-6 md:size-10">
                                ...
                                <button 
                                    @click="next"
                                    id="next" 
                                    class="absolute top-1/2 transform -translate-y-1/2 right-0 bg-slate-100 text-blue-600 hover:bg-blue-500 hover:text-white transition font-bold rounded-full w-10 h-10 md:w-12 md:h-12 shadow flex justify-center items-center mr-2 md:mr-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="size-6 md:size-10">
