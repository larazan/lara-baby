...
<footer class="relative w-full bg-[#120a55] ">
    ...
    <div class="mx-auto max-w-6xl px-6 lg:px-10 xl:px-0 pb-10 pt-10 md:pt-16">
        <div class="xl:grid xl:grid-cols-4 xl:gap-8">
            <div class="xl:pr-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-1 gap-8 xl:gap-0">
                    <div class="pr-3 xl:pr-0">
                        <img src="/frontend/img/logo.svg" width="100" height="100" class="" alt="logo" />
                        <div class="hidden xl:mt-8">
                            <h3 class="text-sm leading-[22px] md:text-base md:leading-[25px] font-bold text-orange-400 uppercase"> Kontak Kami </h3>
                            <ul role="list" class="mt-5 space-y-3">
                                <li class="flex gap-4">
                                    <div>
                                        <div class="flex w-6 h-6"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" class="text-white">
                                    ...
                                    <p class="text-sm leading-[22px] md:text-base md:leading-[25px] font-medium text-white"> Jl. Angkasa I No.2 Kemayoran, Jakarta Pusat 10610, PO Box 3540 Jkt. </p>
                                </li>
                                <li class="flex gap-4">
                                    <div>
                                        <div class="flex w-6 h-6"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" class="text-white">
                                    ...
                                    <p class="text-sm leading-[22px] md:text-base md:leading-[25px] font-medium text-white"> Contact Center (021) 196 <br> Faks (021) 4246703 </p>
                                </li>
                                <li class="flex gap-4">
                                    <div>
                                        <div class="flex w-6 h-6"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" data-slot="icon" class="text-white">
                                    ...
                                    <p class="text-sm leading-[22px] md:text-base md:leading-[25px] font-medium text-white hover:text-orange-400"> cc196[at]bmkg.go.id </p>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="mt-6 md:mt-10 xl:col-span-3 xl:mt-0">
                    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 xl:gap-0">
                        ...
                        <div class="">
                            <div class="hidden mt-5 grid2 grid-cols-2 gap-4">
                                <div><a href="https://play.google.com/store/apps/details?id=com.Info_BMKG" aria-label="Unduh Aplikasi Info BMKG di Google Play Store" rel="noopener noreferrer" class="flex-shrink-0"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 124 40" class="max-w-[140px] w-full">
                                            <rect width="123.81" height="40" fill="#fff" rx="8.384"></rect>
                                            <path fill="#000" d="M97 23.972h1.614V12.785H97zm14.538-7.157-1.85 4.85h-.055l-1.921-4.85h-1.738l2.879 6.778-1.641 3.77h1.684l4.437-10.548zm-9.153 5.886c-.53 0-1.267-.273-1.267-.95 0-.864.919-1.195 1.711-1.195.711 0 1.044.159 1.475.375-.125 1.036-.988 1.77-1.919 1.77m.194-6.131c-1.168 0-2.378.533-2.88 1.713l1.433.618c.306-.618.876-.82 1.475-.82.835 0 1.683.518 1.697 1.44v.114a3.5 3.5 0 0 0-1.683-.431c-1.544 0-3.117.877-3.117 2.518 0 1.497 1.267 2.461 2.685 2.461 1.086 0 1.684-.503 2.06-1.093h.055v.863h1.558v-4.289c0-1.986-1.432-3.094-3.283-3.094m-9.975 1.606h-2.296v-3.834h2.296c1.207 0 1.892 1.034 1.892 1.917 0 .867-.685 1.917-1.892 1.917m-.042-5.391h-3.867v11.186h1.613v-4.238h2.254c1.79 0 3.548-1.34 3.548-3.474s-1.759-3.474-3.548-3.474m-21.09 9.918c-1.115 0-2.048-.966-2.048-2.292 0-1.34.933-2.321 2.048-2.321 1.101 0 1.965.98 1.965 2.32 0 1.327-.864 2.293-1.965 2.293m1.854-5.262h-.056c-.362-.447-1.06-.85-1.937-.85-1.84 0-3.526 1.672-3.526 3.82 0 2.133 1.686 3.791 3.526 3.791.878 0 1.575-.404 1.937-.865h.056v.548c0 1.456-.753 2.235-1.965 2.235-.99 0-1.603-.736-1.854-1.355l-1.407.605c.404 1.01 1.477 2.25 3.26 2.25 1.896 0 3.499-1.155 3.499-3.966v-6.833h-1.533zm2.648 6.53h1.616V12.785h-1.617zm4-3.69c-.043-1.47 1.1-2.22 1.922-2.22.642 0 1.185.331 1.366.808zm5.016-1.268c-.306-.851-1.24-2.422-3.15-2.422-1.895 0-3.47 1.542-3.47 3.805 0 2.134 1.561 3.806 3.651 3.806 1.687 0 2.663-1.067 3.067-1.686l-1.254-.865c-.418.634-.99 1.052-1.812 1.052s-1.408-.39-1.784-1.153l4.919-2.105zm-39.193-1.255v1.615h3.735c-.111.908-.404 1.571-.85 2.032-.543.563-1.394 1.183-2.885 1.183-2.3 0-4.097-1.918-4.097-4.296s1.798-4.297 4.097-4.297c1.24 0 2.146.505 2.815 1.154l1.101-1.139c-.933-.923-2.174-1.629-3.916-1.629-3.15 0-5.797 2.653-5.797 5.91 0 3.259 2.648 5.911 5.797 5.911 1.7 0 2.983-.576 3.986-1.658 1.031-1.067 1.352-2.566 1.352-3.777 0-.375-.028-.72-.084-1.009zm9.584 4.945c-1.115 0-2.077-.951-2.077-2.307 0-1.37.962-2.306 2.077-2.306s2.076.937 2.076 2.306c0 1.355-.961 2.307-2.076 2.307m0-6.112c-2.035 0-3.693 1.6-3.693 3.805 0 2.192 1.658 3.806 3.693 3.806 2.034 0 3.693-1.614 3.693-3.806 0-2.205-1.659-3.805-3.693-3.805m8.056 6.112c-1.115 0-2.076-.951-2.076-2.307 0-1.37.961-2.306 2.076-2.306s2.076.937 2.076 2.306c0 1.355-.961 2.307-2.076 2.307m0-6.112c-2.035 0-3.693 1.6-3.693 3.805 0 2.192 1.658 3.806 3.693 3.806s3.693-1.614 3.693-3.806c0-2.205-1.658-3.805-3.693-3.805"></path>
                                            <path fill="#00C1FF" d="M12.63 10.825c-.254.224-.405.598-.405 1.094v-.112V28.19v-.108c0 .459.13.813.35 1.04l.056.053c.179.158.407.242.67.241.255 0 .544-.08.848-.248l10.99-6.108 3.776-2.098c.48-.266.749-.61.794-.96v-.002c-.045-.35-.314-.694-.794-.96L25.14 16.94l-10.991-6.108c-.305-.168-.593-.249-.85-.249a1 1 0 0 0-.668.24"></path>
                                            <path fill="url(#i-1720509760__a)" d="m12.631 29.174-.056-.052c-.22-.228-.35-.582-.35-1.04v.107-16.378.108c0-.496.151-.87.405-1.094L22.012 20z"></path>
                                            <path fill="url(#i-1720509760__b)" d="M25.14 23.06 22.012 20l3.128-3.059 3.775 2.098c.48.266.749.61.794.96v.002c-.045.35-.314.694-.794.96z"></path>
                                            <path fill="url(#i-1720509760__c)" d="M13.3 29.415a1 1 0 0 1-.669-.24L22.012 20l3.128 3.06-10.991 6.107c-.304.168-.592.248-.849.248"></path>
                                            <path fill="url(#i-1720509760__d)" d="m22.012 20-9.382-9.175a1 1 0 0 1 .669-.24c.257 0 .545.08.85.249l10.99 6.107z"></path>
                                            <path fill="url(#i-1720509760__e)" d="M13.3 29.524a1 1 0 0 1-.669-.241l-.002-.002-.05-.047-.004-.005.056-.055a1 1 0 0 0 .67.241c.255 0 .544-.08.848-.248l10.99-6.108.071.07-.071.039-10.99 6.107a1.84 1.84 0 0 1-.78.247z"></path>
                                            <path fill="url(#i-1720509760__f)" d="M12.575 29.23c-.22-.228-.35-.582-.35-1.04v-.109c0 .459.13.813.35 1.04l.056.053z"></path>
                                            <path fill="url(#i-1720509760__g)" d="m25.21 23.128-.07-.069 3.775-2.098c.48-.266.749-.61.794-.96a.9.9 0 0 1-.088.382c-.117.252-.352.49-.706.686z"></path>
                                            <path fill="url(#i-1720509760__h)" d="M29.709 20c-.045-.351-.314-.695-.794-.961l-3.775-2.098.07-.069 3.705 2.06c.529.293.794.68.794 1.068"></path>
                                            <path fill="url(#i-1720509760__i)" d="M12.225 11.92v-.114q0-.06.003-.12v-.007c.023-.395.148-.703.347-.909l.055.055c-.254.224-.405.598-.405 1.095"></path>
                                            <path fill="url(#i-1720509760__j)" d="m25.14 16.941-10.991-6.107c-.305-.17-.593-.25-.85-.25a1 1 0 0 0-.669.24l-.055-.053q.025-.027.054-.052l.002-.002a1 1 0 0 1 .662-.24h.006c.257 0 .545.08.85.248l11.061 6.147z"></path>
                                            <defs>
                                                <linearGradient id="i-1720509760__a" x1="18.22" x2="10.328" y1="11.638" y2="19.734" gradientUnits="userSpaceOnUse">
                                                ...
                                                <linearGradient id="i-1720509760__b" x1="30.293" x2="11.971" y1="19.947" y2="19.947" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#FFE000"></stop>
                                                    <stop offset=".409" stop-color="#FFBD00"></stop>
                                                    <stop offset=".775" stop-color="orange"></stop>
                                                    <stop offset="1" stop-color="#FF9C00"></stop>
                                                </linearGradient>
                                                <linearGradient id="i-1720509760__c" x1="23.479" x2="10.104" y1="22.909" y2="36.529" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#FF3A44"></stop>
                                                    <stop offset="1" stop-color="#C31162"></stop>
                                                </linearGradient>
                                                <linearGradient id="i-1720509760__d" x1="10.212" x2="16.173" y1="9.465" y2="15.544" gradientUnits="userSpaceOnUse">
                                                ...
                                                <linearGradient id="i-1720509760__e" x1="23.473" x2="12.763" y1="25.031" y2="36.017" gradientUnits="userSpaceOnUse">
                                                    <stop stop-color="#CC2E36"></stop>
                                                    <stop offset="1" stop-color="#9C0E4E"></stop>
                                                </linearGradient>
                                                <linearGradient id="i-1720509760__f" x1="13.474" x2="6.522" y1="11.638" y2="18.77" gradientUnits="userSpaceOnUse">
                                                ...
                                                <linearGradient id="i-1720509760__g" x1="30.293" x2="11.971" y1="20" y2="20" gradientUnits="userSpaceOnUse">
                                                ...
                                                <linearGradient id="i-1720509760__h" x1="30.293" x2="11.971" y1="20" y2="20" gradientUnits="userSpaceOnUse">
                                                ...
                                                <linearGradient id="i-1720509760__i" x1="13.467" x2="6.763" y1="11.651" y2="18.23" gradientUnits="userSpaceOnUse">
                                                ...
                                                <linearGradient id="i-1720509760__j" x1="10.199" x2="14.981" y1="11.405" y2="16.311" gradientUnits="userSpaceOnUse">
