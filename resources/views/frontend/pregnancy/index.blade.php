                ...
                <div class="mx-auto max-w-lg px-6 lg:px-10 xl:px-0">
                    <div class="flex flex-col items-center justify-center gap-4">
                        ...
                        <div class="flex items-center gap-2.5 text-center max-w-[700px]"><!---->
                            <h1 class="text-lg leading-[33px] md:text-[32px] md:leading-[48px] xl:text-[40px] xl:leading-[54px] font-bold text-white figtree-bold">Pregnancy Tracker: Day by Day</h1>
                        </div>
                        <div>
                            <p class=" md: md:leading-[25px] text-white text-center max-w-[905px] figtree-reguler">Get a daily look at how your baby is growing and find timely guidance for every week and trimester of your pregnancy.</p>
                        </div>
                    ...
                    <li class="item flex items-start gap-x-3 py-4 relative w-full" >
                        <a href="{{ url('pregnancy/tracker/'.$article->categorySlug($article->category_id).'/'.$article->slug) }}" class="item-img shrink-0 overflow-hidden rounded aspect-square w-[100px] relative" aria-label="{{ $article->title }}" >
                            <div class="flex bg-white border-2 p-2 border-sky-500 rounded-md w-full h-full object-cover">
                                ...
                                @endphp
                                <div class="flex">
                                    <span class="text-gray-700 text-xs font-semibold leading-tight figtree-medium">{{ $arr[1] }} weeks</span>
                                </div>
