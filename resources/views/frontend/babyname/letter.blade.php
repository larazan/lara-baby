                ...
                <div class="py-3 md:py-1 md:pb-5 col-span-full col-start-1 flex flex-col gap-4 mx-auto max-w-6xl md:px-6 lg:px-10 xl:px-0 md:flex-nowrap xl:col-start-4 xl:col-end-12">
                    <form action="{{ url('baby-name') }}" method="GET">
                        ...
                        <div class="flex mx-auto w-full max-w-2xl px-0 py-3 ">
                            <button type="submit" class="flex w-full mx-auto py-2 md:py-3 rounded-full border-2 border-gray-800 shadow-menu items-center justify-center bg-blue-700 hover:bg-blue-800 font-semibold text-white figtree-medium">
                                Browse
                            </button>
                        </div>
                    </form>
                ...
                <div class="bg-white pb-0 md:pb-10">
                    <div class="mx-auto max-w-6xl md:px-6 lg:px-10 xl:px-0">
                        <div class="flex justify-between">
                            <h2 class="text-md md:text-[24px] md:leading-[33px] lg:text-[32px] lg:leading-[48px] font-bold text-gray-900 figtree-medium">Found {{ $countNames }} Results Names</h2>
                        </div>
                        <div
                            x-data="{
