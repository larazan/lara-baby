...
<main class="flex bg-white min-h-screen pt-16 md:pt-[68px] max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="w-full flex-grow max-w-6xl sm:mx-auto p-2 px-2 sm:py-8 space-y-8">
        <div class="w-full ">
            <div class="w-full flex flex-col col-span-5 ">
                <div class="hidden flex2 flex-row-row justify-between">
                    <span class="pally-bold text-2xl">Detail</span>
                </div>

                <div class="top-0 max-w-md md:max-w-2xl mx-auto w-full py-2 bg-white flex flex-col space-y-2 md:space-y-0 md:flex-row md:items-center justify-start md:justify-between">
                    <div class="flex flex-row-row space-x-2">
                        <button class="flex items-center justify-center px-3 py-2 bg-white2 text-gray-900 hover:bg-gray-200 rounded-sm border shadow border-gray-300 cursor-pointer bg-white hover:text-black pally-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-share-3">
                        ...
                        <button class="flex items-center justify-center px-3 py-2 bg-white2 text-gray-900 hover:bg-gray-200 rounded-sm border shadow border-gray-300 cursor-pointer bg-white hover:text-black pally-medium">
                            ...
                            <span class="text-sm ml-1">Download</span>
                        </button>
                    </div>
                    <div class="flex z-10 flex-row space-x-2">
                        
                        <a href="{{ url('fact/'.$fact->uuid.'/customize') }}" class="flex items-center justify-center px-3 py-2 text-[#2e659d] rounded-md border shadow border-gray-300 cursor-pointer hover:border-gray-300 bg-[#e1ebf5] pally-medium">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-4 md:size-5 rotate-90">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
                            </svg>
                            <span class="text-sm ml-1">Costumize</span>
                        </a>
                        
                        <div class="relative flex" x-data="{ input: '{{ $fact->title }}', showMsg: false, clickCopy: false }">
                            <button 
                                class="flex items-center justify-center px-3 py-2 text-white rounded-md border shadow border-blue-700 cursor-pointer bg-[#076ed3] pally-medium"
                            ...
                            >
                                ...
                                <span class="text-sm ml-1">Copy</span>
                            </button>
                            <div 
                                class="absolute bottom-full left-1/2 z-20 mb-3 -translate-x-1/2 whitespace-nowrap rounded-md bg-gray-700 py-2 px-4 text-xs text-white font-medium transition-opacity duration-300 border border-gray-300 shadow-[0px_12px_30px_-4px_rgba(16,24,40,0.08);]"
                                x-show="showMsg" @click.away="showMsg = false"
                                style="display: none;"
                            >
                                <span class="absolute -bottom-1.5 left-1/2 -z-10 h-3 w-3 border-b border-r border-gray-800 -translate-x-1/2 rotate-45 bg-gray-700"></span>
                                Copy to clipboard
                            </div>
                        </div>
                    </div>
                ...
                <div class="flex flex-1 flex-col items-center justify-center relative">
                    <div class="flex flex-1 flex-col pb-18 max-w-md md:max-w-2xl ">
                        <section class="w-full mx-auto md:mt-0 px-0 pb-10">

                            <div class="py-4 md:py-6 w-full h-full2 columns-1 ">
                                <div 
                                    class="relative mb-4 rounded w-full min-h-[400px] md:min-h-[450px] border group flex flex-col overflow-hidden justify-center shadow-md items-center" 
                                ...
                                >
                                    <div class="flex flex-col justify-center items-center px-10 md:px-20 py-6 lg:py-4 md:py-6">
                                        ...
                                        <p 
                                            class="mt-4 leading-tight md:leading-tight text-wrap text-white text-center text-3xl md:text-5xl lg:text-2xl pally-bold"
                                    ...
                                    <div class="absolute z-10 bottom-0 h-full w-full rounded-md px-2 pt-0 opacity-0 group-hover:opacity-100 bg-gradient-to-b from-transparent to-[#0a1016]">
                                        <div class="absolute top-3 right-3 ">
                                            <div class="flex justify-between">
                                                <a href="/" class="flex justify-end items-end text-white">
                                        ...
                                        <div class="absolute bottom-0 right-0 px-3 py-3 mb-2">
                                ...
                                <div class="flex flex-wrap2 w-full items-center space-x-1 px-2 md:px-4 py-2">
                                    ...
                                    <div class="flex flex-wrap gap-x-2 w-full">
                                        ...
                                        @endphp
                                        <a href="">
                                            <div class=" mt-1 mb-1 py-1 px-3 text-sm bg-white border border-slate-300 rounded-xs flex items-center text-slate-900 gap-x-1 hover:bg-slate-200 transition cursor-pointer">
                                                <div class="truncate tracking-wide text-xs font-semibold capitalize">{{ $t }}</div>
                                            </div>
                                        </a>
                                        @endforeach
                                        @else
