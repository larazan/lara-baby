...
<form class="y">
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">
                                    {{ ($segments->currentpage()-1) * $segments->perpage() + $loop->index + 1 }}
                                </div>
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteModal({{ $segment->id }})">
    ...
    <x-dialog-modal wire:model="showAdvertisingSegmentModal" class="">
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeAdvertisingSegmentModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($segmentId)
                    <x-button wire:click="updateAdvertisingSegment" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createAdvertisingSegment" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
