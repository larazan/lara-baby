...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Religion</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <button class="btn ho xi ye" wire:click="showCreateModal">
                ...
                <span class="hidden trm nq">Create Religion</span>
            </button>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Religion List <span class="gq gp"></span></h2>
        </header>
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">
                                    {{ ($religions->currentpage()-1) * $religions->perpage() + $loop->index + 1 }}
                                </div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{{ $religion->name }}</div>
                            </td>
                            
                            <td class="vi wy w_ vo lm">
                                <div>{{ $religion->created_at->format('d-m-Y') }}</div>
                            </td>

                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $religion->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteModal({{ $religion->id }})">
    ...
    <x-dialog-modal wire:model="showReligionModal" class="">

        @if ($religionId)
        <x-slot name="title" class="border-b">Update Religion</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Religion</span>
        </x-slot>
        @endif
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeReligionModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($religionId)
                    <x-button wire:click="updateReligion" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createReligion" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
