<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Contact</h1>
        </div>
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Contacts <span class="gq gp"></span></h2>
        </header>
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteModal({{ $contact->id }})">
    ...
    <x-dialog-modal wire:model="showContactModal" class="">
        ...
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Contact</span>
        </x-slot>
        @endif
