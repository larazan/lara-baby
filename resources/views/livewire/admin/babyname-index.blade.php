...
<x-loading-indicator />
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Babyname</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <a href="{{ url('admin/import') }}" class="btn ho xi ye">
            ...
            <!-- Create babyname button -->
            <button class="btn ho xi ye" wire:click="showCreateModal">
                <svg class="oo sl du bf ub" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z"></path>
                </svg>
                <span class="hidden trm nq">Create Babyname</span>
            </button>
        </div>
                ...
                <table class="ux ou">
                    ...
                    <tbody class="text-sm le lr">
                        ...
                        <tr wire:key="{{ $babyname->id }}">
                            ...
                            <td class="vi wy w_ vo lm">
                                <livewire:toggle-switch :model="$babyname" field="is_surnameable" :key="$babyname->id" />
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    <button class="gq xv rounded-full" wire:click="showEditModal({{ $babyname->id }})">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteModal({{ $babyname->id }})">
    ...
    <x-dialog-modal wire:model="showBabynameModal" class="">

        @if ($babynameId)
        <x-slot name="title" class="border-b">Update Babyname</x-slot>
        @else
        <x-slot name="title" class="border-b bg-slate-200">
            <span class="font-semibold">Create Babyname</span>
        </x-slot>
        @endif
                                ...
                                <div class="">
                                    <div class="flex flex-col space-y-3">
                                        <div class="flex flex-row justify-between space-x-2">
                                            ...
                                            <div class="col-start-1 sm:col-span-3 w-full">
                                                <label for="pronounce" class="block text-sm font-medium text-gray-700">
                                                    Pronounce
                                                </label>
                                                <input wire:model="pronounce" type="text" autocomplete="given-name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                                                @error('pronounce')
                                                    <div class="go re yl">{{ $message }}</div>
                                                @enderror
                                            </div>
        ...
        <x-slot name="footer">
            <div class="border-slate-200">
                <div class="flex flex-wrap justify-end fc">
                    <x-button wire:click="closeBabynameModal" class="border-slate-200 hover:text-white hover--border-slate-300 g_">Cancel</x-button>
                    @if ($babynameId)
                    <x-button wire:click="updateBabyname" class=" ho xi ye">Update</x-button>
                    @else
                    <x-button wire:click="createBabyname" class=" ho xi ye2">Create</x-button>
                    @endif
                </div>
            </div>
