<div class="vs jj ttm vl ou uf na">
    ...
    <div class="je jd jc ii">
        ...
        <!-- Left: Title -->
        <div class="ri _y">
            <h1 class="gu teu text-slate-800 font-bold">Activity</h1>
        </div>
        ...
        <div class="sn am jo az jp ft">
            ...
            <a href="{{ url('admin/activity/create') }}" class="btn ho xi ye">
                <svg class="oo sl du bf ub" viewBox="0 0 16 16">
                    <path d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z"></path>
                </svg>
                <span class="hidden trm nq">Create Activity</span>
            </a>
        </div>
    ...
    <div class="je jd jc ii">
        ...
        <div class="ri _y">
            ...
            <form class="y">
                ...
                <button class="g w j kk" type="submit" aria-activity="Search">
    ...
    <div class="bg-white bd rounded-sm border border-slate-200 rc">
        <header class="vc vu">
            <h2 class="gh text-slate-800">Activitys <span class="gq gp"></span></h2>
        </header>
                        ...
                        <tr>
                            ...
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">
                                    {{ ($activities->currentpage()-1) * $activities->perpage() + $loop->index + 1 }}
                                </div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                <div class="gp text-slate-800">{!! nl2br(General::smart_wordwrap($activity->title, 40)) !!}</div>
                            </td>
                            <td class="vi wy w_ vo lm">
                                @if($activity->original)
                                <div class="gp ">
                                    <img src="{{ asset('storage/'.$activity->original) }}" class="object-scale-down h-48 w-96" alt="{{ $activity->title }}">
                                </div>
                                @endif
                            </td>
                            <td class="vi wy w_ vo lm">
                            ...
                            <td class="vi wy w_ vo lm of">
                                <div class="fm">
                                    ...
                                    <button class="yl xy rounded-full" wire:click="deleteModal({{ $activity->id }})">
